 ...
 * Control - Switch.
 *
 * @package Architecture Building Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Architecture_Building_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'architecture-building-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'architecture-building-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
