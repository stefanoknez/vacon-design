...
class Architecture_Building_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'architecture-building' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $architecture_building_font_awesome_icon_array = architecture_building_font_awesome_icon_array();
                    foreach ($architecture_building_font_awesome_icon_array as $architecture_building_font_awesome_icon) {
                            $icon_class = $this->value() == $architecture_building_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($architecture_building_font_awesome_icon).'"></i>
                            <span class="architecture-building-social-class">'.esc_attr($architecture_building_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function architecture_building_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'architecture-building-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'architecture_building_customizer_script' );

if(!function_exists('architecture_building_font_awesome_icon_array')){
    function architecture_building_font_awesome_icon_array(){
