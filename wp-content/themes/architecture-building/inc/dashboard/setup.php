<?php //to use wp udpate plugin
    ...
    if (!$menu_exists) {
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Home', 'architecture-building'),
      ...
      $parent_page_item_id = wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Pages', 'architecture-building'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Left Sidebar', 'architecture-building'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Right Sidebar', 'architecture-building'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Projects', 'architecture-building'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Portfolio', 'architecture-building'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Contact', 'architecture-building'),
    ...
    set_theme_mod('architecture_building_slider_count','3');
    ...
    for($i=1;$i<=3;$i++){
      ...
      $architecture_building_post_image_url = get_template_directory_uri().'/assets/images/slider'.$i.'.png';

      $architecture_building_image_name = 'slider'.$i.'.png';
