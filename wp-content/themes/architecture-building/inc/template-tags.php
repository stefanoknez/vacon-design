...
function architecture_building_entry_footer() {
	...
	$architecture_building_categories_list = get_the_category_list( $separate_meta );
	$tags_list = get_the_tag_list( '', $separate_meta );
	if ( ( ( architecture_building_categorized_blog() && $architecture_building_categories_list ) || $tags_list ) || get_edit_post_link() ) {
