...
if( class_exists( 'WP_Customize_Control' ) ) {
	class Civil_Engineering_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'civil-engineering-control-switch', trailingslashit( get_template_directory_uri() ) . 'assets/js/custom-controls.js', array( 'jquery' ) );

			wp_enqueue_style( 'civil-engineering-control-switch', trailingslashit( get_template_directory_uri() ) . 'assets/css/custom-controls.css', '', time() );
...
if( class_exists( 'WP_Customize_Control' ) ) {
	class Civil_Engineering_Customizer_Customcontrol_Section_Heading extends WP_Customize_Control {
